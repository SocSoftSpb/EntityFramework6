...
namespace ProductivityApiTests
{
    ...
    public class SimpleScenariosForSqlCe : FunctionalTestBase, IDisposable
    {
        ...
        [Fact]
        public void
            SqlCe_Database_can_be_created_with_columns_that_explicitly_total_more_that_8060_bytes_but_data_longer_than_8060_cannot_be_inserted
            ()
        {
        ...
        public void Scenario_Using_two_databases_OnSqlCe()
        {
            ...
            RunInSqlCeTransaction<CeLoginsContext>(
                context =>
                    {
                        var login = new Login
                                        {
