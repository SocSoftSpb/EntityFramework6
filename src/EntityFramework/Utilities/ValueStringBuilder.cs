...
namespace System.Data.Entity.Utilities
{
    ...
    internal ref struct ValueStringBuilder
    {
        ...
        /// <summary>
        /// Формирование строки и освобождение ресурсов
        /// </summary>
        /// <returns></returns>
        ...
        public void Remove(int startIndex, int length)
        {
            ...
            if (startIndex == 0)
            {
                _chars = _chars.Slice(startIndex);
            }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static uint DivRem(uint a, uint b, out uint result)
        {
            uint div = a / b;
            result = a - div * b;
            return div;
