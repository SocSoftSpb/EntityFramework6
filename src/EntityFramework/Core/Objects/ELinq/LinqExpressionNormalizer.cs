...
namespace System.Data.Entity.Core.Objects.ELinq
{
    ...
    internal class LinqExpressionNormalizer : EntityExpressionVisitor
    {
        ...
        private static readonly Lazy<MethodInfo> _enumerableContainsMethod = new(() =>
            typeof(Enumerable)
                .GetMethods()
        ...
        private static readonly Lazy<MethodInfo> _enumerableSequenceEqualMethod = new(() =>
            typeof(Enumerable)
                .GetMethods()
                .Single(method => method.Name == nameof(Enumerable.SequenceEqual) && method.GetParameters().Length == 2));
