...
namespace System.Data.Entity
{
    ...
    public static class EntityEnumerableExtensions
    {
        ...
        /// <returns>An IQueryable&lt;T&gt; that contains the specified number of elements from the start of the input sequence.</returns>
        /// <remarks>
        ...
        /// <summary>
        /// Wrap <paramref name="source"/> to a subquery 
        /// </summary>
        /// <param name="source">The sequence to return elements from</param>
        /// <typeparam name="TSource">An IQueryable&lt;T&gt; that will be wrapped to a subquery.</typeparam>
        /// <returns></returns>
        public static IQueryable<TSource> AsSubQuery<TSource>(this IQueryable<TSource> source)
        {
            return BootstrapHelper.BootstrapFunction(e => e.AsSubQuery(), source);
        }
        ...
        /// </summary>
        /// <param name="source">The sequence to return elements from</param>
        /// <typeparam name="TSource">An IEnumerable&lt;T&gt; that will be wrapped to a subquery.</typeparam>
        /// <returns></returns>
        public static IEnumerable<TSource> AsSubQuery<TSource>(this IEnumerable<TSource> source)
        {
            return BootstrapHelper.BootstrapFunction(e => e.AsSubQuery(), source);
        }
        ...
        {
            public static IQueryable<TOut> BootstrapFunction<TIn, TOut>(Expression<Func<IQueryable<TIn>, IQueryable<TOut>>> methodExpression, IQueryable<TIn> collection)
            {
                ...
                return collection.Provider.CreateQuery<TOut>(
                    Expression.Call(((MethodCallExpression)methodExpression.Body).Method, collection.Expression));
            }
            ...
            public static IEnumerable<TOut> BootstrapFunction<TIn, TOut>(Expression<Func<IQueryable<TIn>, IQueryable<TOut>>> methodExpression, IEnumerable<TIn> collection)
            {
                if (collection is IQueryable<TIn> asQueryable)
                {
                    ...
                    return asQueryable.Provider.CreateQuery<TOut>(
                        Expression.Call(((MethodCallExpression)methodExpression.Body).Method, asQueryable.Expression));
                }
