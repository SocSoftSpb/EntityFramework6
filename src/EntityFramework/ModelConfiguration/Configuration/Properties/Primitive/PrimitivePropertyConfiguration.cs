...
namespace System.Data.Entity.ModelConfiguration.Configuration.Properties.Primitive
{
    ...
    public class PrimitivePropertyConfiguration : PropertyConfiguration
    {
        ...
        /// <summary>
        /// Gets annotations for this property
        /// </summary>
        ...
        /// <summary>
        /// Set annotation for property
        /// </summary>
        /// <param name="name">annotation name</param>
        /// <param name="value">annotation text</param>
        ...
        /// <summary>
        /// Configure column of table
        /// </summary>
        /// <param name="column">Table column</param>
        /// <param name="table">Table</param>
        /// <param name="providerManifest">Manifest</param>
