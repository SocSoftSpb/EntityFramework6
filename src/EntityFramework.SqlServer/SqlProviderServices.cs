...
namespace System.Data.Entity.SqlServer
{
    ...
    public sealed class SqlProviderServices : DbProviderServices
    {
        ...
        /// <summary>
        /// Get or sets a value indicating whether <see cref="decimal" /> parameter values are truncated to 
        /// the scale (number of decimal places) defined for their corresponding columns when they are sent 
        /// to the database. A value of <c>true</c> indicates that <see cref="SqlParameter" /> objects 
        /// created for <see cref="decimal" /> columns will have their <see cref="SqlParameter.Scale" /> 
        /// properties set, which will cause the parameter values to be truncated. If set to <c>false</c> 
        /// then the <see cref="SqlParameter.Scale" /> properties will not be set, avoiding the truncation 
